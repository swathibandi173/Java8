...
public class CreateOwnLocalDateTimeUsingLocalDateTimeMethod {
	...
	public static void main(String[] args) {
		...
		LocalDateTime createOwnDateTime1 = LocalDateTime.of(2021, Month.OCTOBER, 22, 12, 9, 22);
		System.out.println("createOwnDateTime1: " + createOwnDateTime1);
		
		// Create own LocalDateTime from STRING using parse method
		String dateString = "2021-10-22T12:09:22";
		...
		String str1 = "2021-10-22 12:30:22";
		// Define formatter
		...
		LocalDateTime localDateTime2 = LocalDateTime.of(2021, 10, 22, 12, 36, 22);
